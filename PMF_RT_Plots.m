...
% returns parameter fits (mean, sd for cumulative gaussian PMF fitting, b0,
...
data = rt_choice_cohlevel_correct_respID; % make copy of behavioural data matrix
...
% if data has 5 columns it has an identity column which tells us to
